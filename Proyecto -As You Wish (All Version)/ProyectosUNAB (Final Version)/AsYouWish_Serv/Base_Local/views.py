...
from Base_Local.filters import Filtro_LocalPago
...
def Estado_CasaMatriz(request):
	...
	Filtro_Pago = Filtro_LocalPago(request.GET, queryset=Lcl)
	Lcl = Filtro_Pago.qs
	context = {
		"Lista_HTML":Lcl,
		'Filtro':Filtro_LocalPago
	}
	return render(request,"Locales/CasaMatriz.html", context)
...
def Estado_Bellavista(request):
	...
	return render(request,"Locales/Bellavista.html", context)
...
def Estado_Providencia(request):
	...
	return render(request,"Locales/Providencia.html", context)
...
def Estado_LaFlorida(request):
	...
	return render(request,"Locales/LaFlorida.html", context)